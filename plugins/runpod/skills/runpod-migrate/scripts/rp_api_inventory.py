...
SIGNALS: list[tuple[str, str, str, str]] = [
    ...
    ("v1", "billing", r"/billing/(pods|endpoints|networkvolumes)\b", "→ /v2/billing/{pods,serverless,endpoints,networkvolumes} — note v1 /billing/endpoints (serverless) is v2 /billing/serverless.", V2_CONTEXT),
    ...
    ("v1-field", "pod", r"\b(minRAMPerGPU|minVCPUPerGPU|minDownloadMbps|minUploadMbps|minDiskBandwidthMBps|countryCodes|supportPublicIp|volumeEncrypted|interruptible)\b", "Removed in v2 — no equivalent. Drop it or stay on v1/GraphQL for this call."),
    ("v1-field", "pod", r"\b(allowedCudaVersions|minCudaVersion)\b", "Removed from v2 create. `minCudaVersion` survives only as a /v2/catalog/gpus availability filter."),
    ...
    ("v1-field", "serverless", r"\btemplateId\b", "v2 create/update REJECTS templateId (422). Inline the template's container fields instead."),
