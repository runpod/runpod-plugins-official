...
SIGNALS: list[tuple[str, str, str, str]] = [
    ...
    ("v1-field", "pod", r"\bcountryCodes\b", "No create-time equivalent in v2. It survives only as a /v2/catalog/gpus?include=AVAILABILITY read filter, so it can choose a deployment target but cannot constrain the create."),
